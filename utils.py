...
def analyze_resume(client, text_content):
    ...
    2. 각 프로젝트의 성과(results)는 반드시 3개의 수치화된 결과로 작성해주세요.제공되지 않은 수치에 대해서는 임의표기말고 '00%'로 표기해주세요. 
        ...
        "work_experience": [
            {
                ...
                "responsibilities": [
                    ...
                    {
                        "project": "프로젝트 2: 신규 브랜드 런칭 캠페인",
                        "details": [
                            "신규 브랜드 컨셉 기획 및 시장 조사 실시.",
                            "캠페인 영상 및 디지털 광고 콘텐츠 제작.",
                            "온/오프라인 프로모션 이벤트 기획 및 실행.",
                            "협력 업체 및 인플루언서 네트워킹 구축.",
                            "브랜드 런칭 관련 PR 및 미디어 커버리지 확보."
                        ],
                        "results": [
                            "브랜드 인지도 40% 상승.",
                            "캠페인 관련 소셜 미디어 참여율 20% 증가.",
                            "런칭 후 3개월 내 매출 30% 성장."
                        ]
                    }
                ]
